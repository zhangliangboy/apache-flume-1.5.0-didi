 ...
 * an instance of Flume's {@link AvroSource}, which allows Flume agents to
 * forward to other Flume agents, forming a tiered collection infrastructure. Of
 * course, nothing prevents one from using this sink to speak to other custom
